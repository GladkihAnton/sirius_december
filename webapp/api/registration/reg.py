...
from webapp.crud.user import create_user, get_user_by_email, get_user_by_username
...
async def register(
    ...
    if existing_user:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail='Username уже используется')
